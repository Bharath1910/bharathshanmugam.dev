            ...
            <div className="bg-background h-[80vh] 2xl:h-[90vh] flex">
                <div className="flex-1 text-xl text-white flex justify-center items-center px-4 md:px-8 pb-16 xl:pl-28 z-10">
                    <div className='flex flex-col gap-4 cursor-default'>
                        ...
                        <p className='text-[70px] md:text-7xl 2xl:text-8xl leading-none font-raleway font-extrabold'><span className="underline decoration-pink decoration-8">I'm a Backend</span> developer, from <span className={styles.grad}>India.</span></p>
